...
def main(request_data):
    ...
    investment = Investment_Trading_Securities_NSFR_output.nsfr_investmentandtradingsecurities(extra_tables_request.get("Investment&Trading_Securities", date_str))
    securities_financial_trans = Securities_Financial_Trans_NSFR.nsfr_securitiesfinancialtrans(extra_tables_request.get("Securities_Financial_Trans", date_str))
    ...
    offbalancesheet = Off_Balance_Sheet_NSFR_output.nsfr_offbalancesheet(extra_tables_request.get("Off_Balance_Sheet", date_str))
    other_items = Other_NSFR_Items.nsfr_New_Other_Items(extra_tables_request.get("Other_Items", date_str))
    issued_securities = Issued_NSFR_Securities.Issued_Securities_NSFR(extra_tables_request.get("Issued_Securities", date_str))
    deposit = Deposits_NSFR_output.nsfr_deposits(extra_tables_request.get("Deposit", date_str))
    dep_w_other_banks_nsfr = Deposits_with_other_banks_NSFR_output.NSFR_Deposits_with_Other_Banks(extra_tables_request.get("Deposits_with_Other_Banks", date_str))
    loans_and_advances = Loans_Advances_NSFR.Loans_Advances_NSFR(extra_tables_request.get("Loans_&_Advances", date_str))
    #collecteral = 
