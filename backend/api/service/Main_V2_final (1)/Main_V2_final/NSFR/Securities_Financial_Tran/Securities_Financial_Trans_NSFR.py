...
def nsfr_securitiesfinancialtrans(path, input_date_str):
    sec = f"Securities Financial Trans_{input_date_str}.csv"
    df1 =  pd.read_csv(os.path.join(path, 'Securities_Financial_Trans', 'input', sec))
...
#output file
output_df = nsfr_securitiesfinancialtrans(path, "28-08-2023")
