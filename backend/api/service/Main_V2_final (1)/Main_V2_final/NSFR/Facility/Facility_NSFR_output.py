...
def nsfr_facility(path, input_date_str):
    fac = f"Facility_{input_date_str}.csv"
    df1 =  pd.read_csv(os.path.join(path, 'input', fac))
...
#output file
final_output_df = nsfr_facility(path, "28-08-2023")
