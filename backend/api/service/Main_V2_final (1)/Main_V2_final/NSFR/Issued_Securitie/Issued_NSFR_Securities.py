...
def Issued_Securities_NSFR(path, input_date_str):
    iss = f"Issued Securities_{input_date_str}.csv"
    df1 = pd.read_csv(os.path.join(path, 'Issued_Securities', 'input', iss))
...
#output file
output_df = Issued_Securities_NSFR(path, "28-08-2023")
