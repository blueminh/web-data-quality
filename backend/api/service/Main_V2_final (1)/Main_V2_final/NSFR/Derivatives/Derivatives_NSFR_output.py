...
def nsfr_derivatives(path, input_date_str):
    dev = f"Derivatives_{input_date_str}.csv"
    df1 =  pd.read_csv(os.path.join(path, 'Derivatives', 'input', dev))
...
#output file
final_output_df = nsfr_derivatives(path, "28-08-2023")
