...
def nsfr_borrowings(path, input_date_str):
    borrowings_filename = f"Borrowings_{input_date_str}.csv"
    df1 = pd.read_csv(os.path.join(path,'Borrowings', 'input', borrowings_filename))
...
final_output_df = nsfr_borrowings(path, "28-08-2023")
